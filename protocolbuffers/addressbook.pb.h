...
class AddressBook;
struct AddressBookGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern AddressBookGlobalsTypeInternal AddressBook_globals_;
extern const ::google::protobuf::internal::ClassDataFull AddressBook_class_data_;
#else
extern const AddressBookGlobalsTypeInternal AddressBook_globals_;
...
struct Person_PhoneNumberGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern Person_PhoneNumberGlobalsTypeInternal Person_PhoneNumber_globals_;
extern const ::google::protobuf::internal::ClassDataFull Person_PhoneNumber_class_data_;
#else
extern const Person_PhoneNumberGlobalsTypeInternal Person_PhoneNumber_globals_;
#endif  // PROTOBUF_MESSAGE_GLOBALS
}  // namespace tutorial
namespace google {
namespace protobuf {
...
namespace tutorial {
// this is the nested class for a person's phone number that the compiler created
enum Person_PhoneType : int {
...
/* @@protoc_insertion_point(class_definition:tutorial.Person.PhoneNumber) */ {
 public:
  ...
  inline Person_PhoneNumber(Person_PhoneNumber&& from) noexcept : Person_PhoneNumber(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const Person_PhoneNumber& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<Person_PhoneNumber>(&Person_PhoneNumber_globals_);
  }
  ...
  // implements Message ----------------------------------------------
  // in protocol buffers, you can not add behavior to the generated classes by inheriting from them because they are basically data holders
  ...
  // checks if all required fields have been set (this is for each message in the proto file)
  public:
...
/* @@protoc_insertion_point(class_definition:tutorial.Person) */ {
 ...
 public:
  ...
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::tutorial::Person_PhoneNumber>&
  phones() const;
  ...
  // compiler has generated accessors for each field. 
  // For example, for the name field, you have the following methods
  public:
  // string name = 1;
  [[nodiscard]] bool has_name() // has methods for singular fields with tracking 
      const;
  void clear_name() ; // clear that unsets back to default
  [[nodiscard]] const ::std::string& name() const;
  template <typename Arg_ = const ::std::string&, typename... Args_>
  void set_name(Arg_&& arg, Args_... args); // setters
  ::std::string* PROTOBUF_NONNULL mutable_name(); // mutable_ getter that lets you get a direct pointer to the string
...
/* @@protoc_insertion_point(class_definition:tutorial.AddressBook) */ {
 public:
  ...
  inline AddressBook(AddressBook&& from) noexcept : AddressBook(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const AddressBook& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<AddressBook>(&AddressBook_globals_);
  }
 ...
 public:
  ...
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::tutorial::Person>&
  people() const;
...
// repeated .tutorial.Person.PhoneNumber phones = 4;
// phones is repeated so you can check the size of the repeated field 
...
inline const ::tutorial::Person_PhoneNumber& Person::phones(int index) const
  ...
  // you can get a specific phone number using its index
...
inline ::tutorial::Person_PhoneNumber* PROTOBUF_NONNULL Person::add_phones()
  ...
  // add another phone number to the message which you can then edit
  return _add;
}
